...
Until a Zenodo DOI is issued, cite this release as:

> Lim, A. X. R. (2026). *Satellite Investigation of Transboundary Haze Transport from Sumatran Fires to George Town, Penang* (Version 1.0.0). Independent research project.

After Zenodo publication, replace this provisional citation with the DOI-bearing citation generated by Zenodo.
